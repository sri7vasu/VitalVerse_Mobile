        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        opType = (_b.sent()) === undefined ? types_1.OpType.INSERT : types_1.OpType.UPDATE;
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 10];
                    case 8:
                        if (!(opType === types_1.OpType.INSERT)) return [3 /*break*/, 10];
                        return [4 /*yield*/, store_1.put(item)];
                    case 9:
                        _b.sent();
                        result.push([instance, opType]);
                ...
                switch (_d.label) {
                    ...
                    case 6:
                        ...
                        filtered = predicateObjs_1
                            ? all.filter(function (m) { return util_1.validatePredicate(m, type_1, predicateObjs_1); })
                            : all;
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 5:
                        ...
                        index_1 = util_1.getIndex(this.schema.namespaces[nameSpace].relationships[modelName]
